...
begin
	using Drifters, StochasticDiffEq, Statistics
...
begin
    IC=ex_SDE.initial_conditions()
	"done with initialization"
end

# ╔═╡ 429a9876-c2ae-4658-a703-a2d2f66ad4d4
P = merge(ex_SDE.default_parameters(), (configuration=:basic,))

# ╔═╡ fd2db517-2282-43da-a543-a1ef59a439c2
begin
    ## Lagrangian Model Run 	
    SDE.main_loop(IC; P...)
end
...
git-tree-sha1 = "0afd0b539857c6c07b4ed3b141d327a8872ab165"
...
git-tree-sha1 = "03f6679bfd35d09cc378fa3dbadbe0c018766296"
...
git-tree-sha1 = "ec5c8952790e8d80a3fa423030ff0bfad26e3b31"
