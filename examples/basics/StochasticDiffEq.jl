...
P = merge(ex_SDE.default_parameters(), (configuration=:dimensional_idealized,))

# ╔═╡ fd2db517-2282-43da-a543-a1ef59a439c2
begin
    ## Lagrangian Model Run 	
    SDE.main_loop(IC,p=0.1,nt=10;P=P)
end
...
git-tree-sha1 = "f58613b44ce12a3a74be0bc4a865cc1f2e776737"
